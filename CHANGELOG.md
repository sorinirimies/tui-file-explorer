...
### Documentation
- Regenerate CHANGELOG.md now that v2.2.0/v2.3.0 tags exist on origin

### Miscellaneous
- Release v2.3.0
- Nightly cargo update 2026-09-12

### Merge
- Reconcile Gitea nightly-deps + v2.3.0 release with local changelog fix
...
### Bug Fixes
- Reconcile Cargo.toml/CHANGELOG.md with published v2.0.0 release
...
### Features
- Auto-merge nightly dependency updates
- Multi-pane layout, file/folder sizes, and snappier rendering
